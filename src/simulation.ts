...
export class Circle extends SimulationElement {
  ...
  on(event: string, callback1: (event: MouseEvent) => void, callback2?: (event: MouseEvent) => void) {
...
export class Arc extends SimulationElement {
  ...
  setStartAngle(angle: number, t = 0) {
